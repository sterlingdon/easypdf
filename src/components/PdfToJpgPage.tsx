...
export default function PdfToJpgPage() {
  ...
  const handleConvert = async () => {
    ...
    try {
      const zipBlob = await PdfToImage.convert(file.file, 'jpg', quality / 100);
  ...
  const handleDownload = () => {
    ...
    link.href = url;
    link.download = 'converted_jpg_images.zip';
  ...
  const successContent = (
    <div className="min-h-screen bg-[#f7f7f7] pb-20" style={{
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 mt-12 text-center">
        ...
        <h1 className="text-4xl font-bold text-slate-900 mb-4">Converted to JPG!</h1>
        <p className="text-slate-500 mb-12">Your PDF pages have been converted to JPG images.</p>
